...
SCORERS = [
        ("add_f=0.0_b=1.0_s=0.5", AddScorer, {"section_weight": 0.5, "truncate":True}),
]


Summarizer = DynamicSummarizer(start_ratio=0.5)

experiment_time = int(time.time())
results_path = Path(f"results/theme2_dynamic_no_header_1049_truncated")
